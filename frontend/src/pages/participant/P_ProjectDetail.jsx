                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className={`text-xs px-3 py-1 rounded-full font-bold border ${
                                project.status === 'กำลังดำเนินการ' ? 'bg-yellow-100 text-yellow-700 border-yellow-200' :
                                project.status === 'เปิดรับสมัคร' ? 'bg-blue-100 text-blue-700 border-blue-200' :
                                project.status === 'ดำเนินการสำเร็จ' ? 'bg-emerald-100 text-emerald-700 border-emerald-200' :
                                project.status === 'วางแผน' ? 'bg-purple-100 text-purple-700 border-purple-200' :
